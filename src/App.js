  ...
  return (
    <div className="app">
      ...
      <section className='app-content-section'>
        <h2>8. 10. v <a href="https://www.boutiquehotelcorso.cz/" target="_blank" title="Hotel" rel="noopener">Hotelu Corso</a></h2>
        <p>Obřad i oslavu si užijem přímo tady <a href="https://goo.gl/maps/YyZu5zetd262" target="_blank" title="Mapa" rel="noopener">nám. Krále Jiřího z Poděbrad 2</a>. S tvým příjezdem počítáme někdy od 13:00.</p>
        ...
        <h2>Děti</h2>
        <p>I píďata si najdou svý. Plánujeme koutek pro nejmenší, a když udeří nuda, zachrání to zdejší <a href="https://www.nasemestecko.cz/" target="_blank" title="Dětský koutek" rel="noopener">Městečko</a> – herní prostor s kavárnou, kde po předchozí domluvě umí i profi hlídání (<a href="https://www.nasemestecko.cz/hlidani-deti-revnice/" title="Kontakt">napiš jim</a>).</p>
        <h3>Zvyky</h3>
        ...
        <p>
          <ul>
            ...
            <li>Poslední vlak do Prahy jede v 23:34. Taxi je možnost. Nebo si bookni <a href="https://www.hotelgrandrevnice.cz/ubytovani/" target="_blank" title="Ubytování" rel="noopener">ubytko v Grandu</a>.</li>
          </ul>
